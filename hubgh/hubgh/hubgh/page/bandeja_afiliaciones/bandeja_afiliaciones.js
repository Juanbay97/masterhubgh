					...
					fields: [{
						...
						options: [
							...
							crossSection("Contacto / residencia", [
								...
								crossRow("Ciudad", contacto.ciudad_nombre || contacto.ciudad),
								crossRow("Departamento", contacto.departamento_residencia_nombre || contacto.departamento_residencia_siesa),
								crossRow("País", contacto.pais_residencia_nombre || contacto.pais_residencia_siesa),
								crossRow("Celular", contacto.celular),
								crossRow("Email", contacto.email),
							]),
							crossSection("Bancarios", [
								crossRow("Banco", bancarios.banco_siesa_nombre || bancarios.banco_siesa),
							...
							crossSection("Laborales", [
								crossRow("PDV", laborales.pdv_destino_nombre || laborales.pdv_destino),
							...
							crossSection("Seguridad social", [
								crossRow("EPS", seguridad.eps_siesa_nombre || seguridad.eps_siesa),
								crossRow("AFP", seguridad.afp_siesa_nombre || seguridad.afp_siesa),
								crossRow("Cesantías", seguridad.cesantias_siesa_nombre || seguridad.cesantias_siesa),
								crossRow("CCF", seguridad.ccf_siesa_nombre || seguridad.ccf_siesa),
