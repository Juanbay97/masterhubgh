				...
				.then(snap => {
					...
					const d = new frappe.ui.Dialog({
						...
						fields: [
							...
							{ fieldname: "ciudad_residencia_label", label: "Ciudad Residencia", fieldtype: "Data", default: contacto.ciudad_nombre || contacto.ciudad || "", read_only: 1 },
							{ fieldname: "departamento_residencia_label", label: "Departamento Residencia", fieldtype: "Data", default: contacto.departamento_residencia_nombre || contacto.departamento_residencia_siesa || "", read_only: 1 },
							{ fieldname: "pais_residencia_label", label: "País Residencia", fieldtype: "Data", default: contacto.pais_residencia_nombre || contacto.pais_residencia_siesa || "", read_only: 1 },
							{ fieldname: "ciudad_residencia_siesa", fieldtype: "Data", default: contacto.ciudad || "", hidden: 1 },
							{ fieldname: "departamento_residencia_siesa", fieldtype: "Data", default: contacto.departamento_residencia_siesa || "", hidden: 1 },
							{ fieldname: "pais_residencia_siesa", fieldtype: "Data", default: contacto.pais_residencia_siesa || "", hidden: 1 },
